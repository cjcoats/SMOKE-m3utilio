...
!.............  For SCC descriptions in the inventory, get max name
!               width
        NWIDTH = 0
        DO I = 1, NINVSCC
            IF( LSCCUSE( I ) ) THEN
...
!.............  For SIC descriptions in the inventory, get max name
!               width
        NWIDTH = 0
        DO I = 1, NINVSIC
            IF( LSICUSE( I ) ) THEN
...
!.............  For GSPRO descriptions in the inventory, get max name
!               width
        NWIDTH = 0
        DO I = 1, NGSPRO
            IF( LSPCUSE( I ) ) THEN
...
!.............  For MACT descriptions in the inventory, get max name
!               width
        NWIDTH = 0
        DO I = 1, NINVMACT
            IF( LMACTUSE( I ) ) THEN
