...
PROGRAM EXTRACTIDA
    ...
    XDEV = PROMPTFFILE( 'Enter logical name for input FIPS/plants list',&
                        .TRUE., .TRUE., 'INRECS', PROGNAME )

    IDEV = PROMPTFFILE( 'Enter logical name for input PTINV file',&
                        .TRUE., .TRUE., 'INFILE', PROGNAME )

    ODEV = PROMPTFFILE( 'Enter logical name for output PTINV file',&
...
9991 WRITE( MESG,94010 ) 'End of FIPS/plant list reached unexpectedly at line', IREC
    CALL M3EXIT( PROGNAME, 0, 0, MESG, 2 )

9992 WRITE( MESG,94010 ) 'End of PTINV input file reached unexpectedly at line', IREC
    CALL M3EXIT( PROGNAME, 0, 0, MESG, 2 )
