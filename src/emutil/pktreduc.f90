          ...
          CASE( 'PROJECTION' )
            ...
            DO I = 1, NRECS( N )
                ...
                IF ( I .EQ. 1 ) THEN
                    ...
                    IF( NSEG .LT. 3 ) THEN
                        MESG = 'First line of packet has < 3 columns'
                    ...
                    ELSE IF ( NSEG .GT. 4 ) THEN
                        MESG = 'First line of packet has > 4 columns'
                        CALL M3EXIT( PROGNAME, 0, 0, MESG, 2 )
            ...
            DO I = 1, NRECS( N )
                ...
                ELSE IF( .NOT. DEFAULT( K ) .AND. RCOUNT( K ) .GT. 0 ) THEN
            ...
            !.......  Write packet tail
            WRITE( ODEV,93000 ) TRIM( PENBUF( N ) )
