...
PROGRAM METSCAN
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'METSCAN'       !  program name
    ...
    DO T = 1, NSTEPS
        ...
        IF( .NOT. READ3( MNAME, VARNAM, 1, JDATE, JTIME, TMPR ) ) THEN
    ...
    DO D = SDAY, EDAY
        ...
        IF( .NOT. WRITE3( ONAME, 'SEASON', JDATE, JTIME, SEASON ) ) THEN

            MESG = 'Problem writing "SEASON" to file "' // TRIM( ONAME ) // '."'
