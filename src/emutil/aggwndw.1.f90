...
!.........  INCLUDES
    INCLUDE 'EMCNST3.EXT'   !  emissions constant parameterstures.
...
!.........  Check that output grid cell size is a multiple of input cell size
    IF( .NOT. EFLAG ) THEN
        CHK_X = XCELL / XCELL3D
        CHK_Y = YCELL / YCELL3D
...
!.........  Check that the grid boundaries are aligned
    IF( .NOT. EFLAG ) THEN
...
!.........  Check that the output grid is entirely within the input grid
    IF( .NOT. EFLAG ) THEN
