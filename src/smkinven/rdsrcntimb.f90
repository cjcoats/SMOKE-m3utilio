...
SUBROUTINE RDSRCORLMB( LINE, CFIP, CLNK, TSCC, NVARPERLN, HDRFLAG, EFLAG )
    ...
    !
    !  REVISION  HISTORY:
    !       Created by C. Seppanen (01/03) based on rdntimb.f
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'RDSRCORLMB'     ! Program name
    ...
    !***********************************************************************
    !   begin body of subroutine RDSRCORLMB

    !.......  Scan for header lines and check to ensure all are set
    !           properly
    CALL GETHDR( MXDATFIL, .TRUE., .TRUE., .FALSE., LINE, ICC, INY, NVAR, IOS )
