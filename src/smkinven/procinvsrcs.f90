...
SUBROUTINE PROCINVSRCS( NRAWSRCS )
    ...
    USE MODSOURC, ONLY: SRCIDA, CSOURCA, CSOURC, CIFIP, CSCC, XLOCA, YLOCA,   &
                        CELLID, IRCLAS, IVTYPE, CLINK, CVTYPE
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'PROCINVSRCS'     ! program name
    ...
    SELECT CASE ( CATEGORY )
      ...
      CASE( 'MOBILE' )
        ...
        DO I = 1, NRAWSRCS
            ...
            CIFIP( S )  = TSRC( 1:FIPLEN3 )
            IRCLAS( S ) = STR2INT( TSRC( RWTPOS3:RWTPOS3+RWTLEN3-1 ) )
            IVTYPE( S ) = STR2INT( TSRC( VIDPOS3:VIDPOS3+VIDLEN3-1 ) )
