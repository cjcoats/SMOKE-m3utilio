...
SUBROUTINE SETNONHAP( NRAWBP )
    ...
    CHARACTER(10), PARAMETER :: PROGNAME    = 'SETNONHAP'     ! program name
    ...
    IF( NNONHAP == 0 ) THEN
        MESG = 'WARNING: No ' // NONHAP // ' calculation was ' //   &
    ...
    DO I = 1, MXIDAT
        ...
        IF( L > 0 ) THEN
            ...
            IF( INVDNAM( I )( L+2:LL ) == VOC_TOG ) THEN
                ...
                IF( NONVPOS < 1 ) THEN
                    MESG = 'ERROR: Pollutant "' // TRIM( NONHAPNAM( NHAP ))//   &
    ...
    DO I = 1, NSRC
                ...
                DO J = 1, NPCNT( I )
                    ...
                    ELSE IF( .NOT. ITEXPL( CPOLRAW ) ) THEN
                        ...
                        IF( TOXPOS > 0 ) THEN
                            ...
                            INVSTAT( TOXPOS ) = 2
                        ELSE
                            MESG = 'ERROR: Non-integrated toxic pollutant "' //    &
                                   TRIM( POLNAM ) //    &
                                   '" was not found in the INVTABLE file.'
                            CALL M3EXIT( PROGNAME, 0, 0, MESG, 2 )
                        END IF
        ...
        DO J = 1, NPCNT( I )
            ...
            DO K = 1, NNONHAP
                ...
                POLVAL( VPOS,NEM ) = POLVAL( VPOS,NEM ) - HAPEANN( K )
                POLVAL( VPOS,NDY ) = POLVAL( VPOS,NDY ) - HAPEDAY( K )
    ...
    ALLOCATE(    TMPIDX( IDXSIZE ),         &
              TMPPOLVAL( IDXSIZE,NPPOL ),   &
              TMPPOSCOD( IDXSIZE ), STAT=IOS )
    ...
    DO I = 1, NSRC
        ...
        IF( NEEDSORT ) THEN
            ...
            CALL SORTI1( NPCNT( I ), TMPIDX( 1:NPCNT( I ) ), IPOSCOD( STIDX:ENDIDX ) )
