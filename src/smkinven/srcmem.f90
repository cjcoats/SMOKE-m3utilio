...
SUBROUTINE SRCMEM( CATEGORY, SORTTYPE, AFLAG, PFLAG, NDIM1, NDIM2, NDIM3 )

    !***************************************************************************
    !  subroutine body starts at line
    !
    !  DESCRIPTION:
    !      This subroutine allocates memory for the inventory sorted and
    !      unsorted arrays. IT deallocates memory, when necessary.
    !
    ...
    CHARACTER(16), PARAMETER :: PROGNAME =  'SRCMEM'     ! program name

    !***********************************************************************
    !   begin body of subroutine SRCMEM
    ...
    SELECT CASE ( SORTTYPE )
      ...
      CASE( 'UNSORTED' )
        ...
        !.......  Deallocate for any source category
        ...
        !.......  Allocate specifically based on source category
        SELECT CASE( CATEGORY )
          ...
          CASE( 'MOBILE' )
            ...
            IF( .NOT. PFLAG .AND.    &
                ...
                DEALLOCATE( IRCLASA, IVTYPEA, CVTYPEA, CLINKA, XLOC1A, YLOC1A, XLOC2A, YLOC2A )
      ...
      CASE( 'SORTED' )
        ...
        !.......  Deallocate for any source category
        !.......  NOTE - do not deallocate CSOURC, CSCC, or IFIP, because they
        !               may be needed for reading day- and hour-specific data
        IF( .NOT. AFLAG .AND. .NOT. PFLAG ) THEN
        ...
        SELECT CASE( CATEGORY )
          ...
          CASE( 'MOBILE' )
            ...
            IF( .NOT. PFLAG .AND.    &
                ...
                DEALLOCATE( IRCLAS, IVTYPE, CVTYPE, CLINK, XLOC1, YLOC1, XLOC2, YLOC2 )
          ...
          CASE( 'POINT' )
            ...
            !.......  Do not deallocate plant description in case needed for
            !                   point sources report.
            IF( .NOT. PFLAG .AND.    &
                .NOT. AFLAG .AND. ASSOCIATED( CISIC ) )    &
                DEALLOCATE( CISIC, XLOCA, YLOCA, STKHT, STKDM, STKTK, STKVE )
