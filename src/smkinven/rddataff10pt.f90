...
SUBROUTINE RDDATAFF10PT( LINE, READDATA, READPOL, IYEAR, DESC,      &
    ...
    !
    !  REVISION  HISTORY:
    !       Created by Dongmei Yang (Oct, 2011) based on rddatantipt.f
    !       Version June 2016 by Carlie Coats:  add fugitive-emissions
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'RDDATAFF10PT'     ! Program name

    !***********************************************************************
    !   begin body of subroutine RDDATAFF10PT
