...
SUBROUTINE RDFF10PD( FDEV, TZONE, TSTEP, MXPDSRC, GETSIZES,   &
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'RDFF10PD'     !  program name
    ...
    IF( FIRSTIME ) THEN
        ...
        ALLOCATE( EMIS( NSRC, NIPPA ),    &
               CEMPOLS( NIPPA ), STAT=IOS )
    ...
    DO             !  Head of period-specific file read loop
        ...
        !        properly
        CALL GETHDR( 1, .FALSE., .FALSE., .FALSE., LINE, ICC, YR4, NPOA, IOS )
