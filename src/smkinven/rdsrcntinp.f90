...
SUBROUTINE RDSRCORLNP( LINE, CFIP, TSCC, NPOLPERLN, HDRFLAG, EFLAG )
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'RDSRCORLNP' ! Program name
    ...
    !***********************************************************************
    !   begin body of subroutine RDSRCORLNP
