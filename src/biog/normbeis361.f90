...
SUBROUTINE NORMBEIS360( CVSW )
    ...
    !       fix "missing" numerics, and related changes
    !***********************************************************************
    !
    ...
    !........  PARAMETERs:
    CHARACTER(16), PARAMETER :: PNAME = 'NORMBEIS360'      ! Program name
    ...
    !***********************************************************************
    !   begin body of subroutine NORMBEIS360
    EFLAG = .FALSE.
    ...
    DO I = 1, NVEG
        IF (EMFAC(I,J) .LT. AMISS3 ) THEN
            MESG = 'ERROR: MISSING EMISSION FACTOR FOR VEG TYPE:' //VGLIST(I)//    &
    ...
    CALL CHECKMEM( IOS, 'LUINDX...SUMLAIW', PNAME )
                    ...
                    IF ( VEGAREA > 0. ) THEN
                        ...
                        IF (IS_AG( M, MODIS12 , MODIS14, NLCD81,    &
                            ...
                            IF( IS_TAG (M,MODIS14) ) THEN
                                NOEM( 1 ) = NOEM( 1 ) + VEGAREA * EMFAC(M,N)*0.333333

                                NOEM( 3 ) = NOEM( 3 ) + VEGAREA * EMFAC(M,N)*0.333333
                            ELSE
