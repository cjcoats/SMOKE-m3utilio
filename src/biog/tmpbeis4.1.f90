...
!
!  REVISION  HISTORY:
!      4/22: Prototype by Jeff Vukovich based of Jesse Bash's proposed
!            modifications
...
!......... .h90ERNAL FUNCTIONS and their descriptions:
    CHARACTER(50),.h90ERNAL :: GETCFDSC
    INTEGER      ,.h90ERNAL :: GETFLINE
    CHARACTER(16),.h90ERNAL :: VERCHAR
...
!.........  Allocate memory for met and emissions
...
!.............  Increment time step
        ...
        IF( HR /= BSTEPS ) THEN
            CALL .h90IME( JDATE, JTIME, 10000 )
        END IF

        CALL .h90IME( MDATE, MTIME, 10000 )

        IF ( M2NAME .EQ. M3NAME ) THEN
            RDATE = MDATE
            RTIME = MTIME
        ELSE
            CALL .h90IME( RDATE, RTIME, 10000 )
        END IF
