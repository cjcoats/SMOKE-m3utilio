...
!
!  DESCRIPTION:
!       computes plume top and bottom for fires
!
...
!.........  Compute plume top and bottom and determine actual height of
!           plume centerline after rise
    TOP  = ZPLM
    DH   = TWOTHD * ZPLM
    BOT  = 0.5 * DH
    ZPLM = DH
