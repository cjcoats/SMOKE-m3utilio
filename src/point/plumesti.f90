...
REAL FUNCTION PLUMRIS( HS, TS, VS, DS )
    ...
    REAL, PARAMETER :: T   = 293.0          !  default ambient air temperature (deg k)
    REAL, PARAMETER :: P  = 960.0           !  default ambient air pressure (mb)
    REAL, PARAMETER :: U  =   2.0           !  default wind speed (m/sec)
    REAL, PARAMETER :: D3 =   1.0 / 3.0     !  one-third
