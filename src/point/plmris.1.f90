...
!***********************************************************************
!  subroutine body starts at line 141
!
!  DESCRIPTION:
...
!       Updated with code from J. Godowitch and G. Pouliot, 2/05
...
!.........  Set minimum wind speed to 1 m/s
    WSTK  = MAX( WSTK, 1.0 )
...
!.................  Compute neutral and stable plume rises
...
!.........  Adjust for layer 1 combustion pt. source stacks with plume
!           rise limited to layer 1; put plume height in middle of layer 2
    IF( ( TWOTHD * ZPLM + STKHT ) <= ZF( 1 ) .AND.&
    &    STKTK > TA( 1 ) ) THEN
        ZPLM = ZH( 2 )
    END IF

!.........  Compute plume rise amount (DH) and actual final plume
!           centerline height (ZPLM)
    DH   = TWOTHD * ZPLM
