...
SUBROUTINE RDFMREF( ADEV )
    ...
    !       related changesTILIO and related changes
    !
    !***********************************************************************
    !
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'RDFMREF'       ! program name
    ...
    IF( EFLAG ) THEN
        MESG = 'Problem(s) found in reference county fuel month settings file.'
        CALL M3EXIT( PROGNAME, 0, 0, MESG, 2 )
    END IF
...
999 MESG = 'End of file'
    MESG = 'End of file reached unexpectedly. ' //&
           CRLF() // BLANK5 //'Check format of COUNTY_FUELMONTH input file.'
    CALL M3EXIT( PROGNAME, 0, 0, MESG, 2 )
