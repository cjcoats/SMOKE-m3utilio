...
SUBROUTINE RDRPVEMFACS( REFIDX, MONTH )
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'RDRPVEMFACS'        ! program name
    ...
    !***********************************************************************
    !   begin body of subroutine RDRPVEMFACS
...
100 CONTINUE
    ...
    !.......  Expected columns:
    ! MOVESScenarioID,yearID,monthID,dayID,hourID,FIPS,SCCsmoke,smokeProcID,temperature,THC,CO ...
