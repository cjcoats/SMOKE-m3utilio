...
INTEGER FUNCTION GETINVYR( LINE )
    ...
    CHARACTER(*), INTENT( IN ) :: LINE        !  description of source category
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'GETINVYR'     ! program name
    ...
    IF( L1 .GT. 0 ) THEN
        ...
        IF( INY .LE. 0 ) THEN
            ...
            MESG = 'Incorrectly set year using INVYEAR packet.'
