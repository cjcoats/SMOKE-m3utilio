...
SUBROUTINE FILLCHRT( NXREF, XTYPE, XTCNT )
    ...
    !
    !  DESCRIPTION:
    !      This subroutine populates the source-characteristics part of the grouped
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'FILLCHRT'     ! program name

    !***********************************************************************
    !   begin body of subroutine FILLCHRT

    !.....  Set up strings for SCC and SIC codes of zero
    ...
    !.....  Store the source characteristics for each x-ref entry, depending
    ...
    !.....  Set up partial SCC strings for saving
    ...
    !.....  NOTE- Cases added in version 1.4 (initially) for cntl/proj only
          CASE( 17 )
