...
SUBROUTINE XFRACTBL( NDIM, NXREF, INDX, CSRC, SPRF, FRAC )
    ...
    !***********************************************************************
    !  subroutine body starts at line  83
    !
    !  DESCRIPTION:
    !       Construct data structures for in-XREF speciation-profile fractions.
    !
    !  PRECONDITIONS REQUIRED:
    !           Read and SORTIC() the XREFS.
    !           Must call before XREFTBL()
    !           FRAC(K) < 0.0 for non-frac XREFs
    !
    !  SUBROUTINES AND FUNCTIONS CALLED:
    !
    !  REVISION  HISTORY:
    !     Created 8/2016 by Carlie J. Coats, Jr., UNC IE, to treat
    !       xref fractional speciation-profiles
    ...
    !                System
    !
    ! COPYRIGHT (C) 2016, Center Environmental Modeling for Policy Development
    ! UNC Institute for the Environment.  All Rights Reserved
    !****************************************************************************/
    ...
    USE MODSPRO, ONLY: CMBMAX, CMBCNT, CMBNP, CMBWGHT, CMBSPCD, CMBPRF, CMBDEX
    ...
    !.........  Statement function:  "is not approximately one", with tolerance TOL=1%
    ...
    !***********************************************************************
    !   Begin body of subroutine COMBOTBL
    ...
    !.............  Count this-pollutant fractional (duplicate) references:
