...
LOGICAL FUNCTION DSCM3LAY( NLAYS, VGTYP, VGTOP, VGLVS )
    ...
    !       related changes.  Bug-fixes in GRDINFO_CHECKER, GRDINFO_DEFINED
    !**************************************************************************
    !
    ...
    !.......   Local parameters
    INTEGER, PARAMETER :: MXLAYTYP = 10

    !.......   Layer structure names arrays
    CHARACTER(7):: LAYNAMES( MXLAYTYP ) = (/ 'TBLLAY3'  &
                                           , 'GISLAY3'  &
                                           , 'VGSGPH3'  &
                                           , 'VGSGPN3'  &
                                           , 'VGSIGZ3'  &
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'DSCM3LAY'     ! program name
            ...
            ELSE
                ...
                IF ( NLAYREAD .GT. MXLAYS3 + 1 ) THEN
                    ...
                    WRITE( MESG,94010 )                         &
                       ...
                       ') exceeds maximum (', MXLAYS3+1, ') at line', IREC
                    CALL M3MSG2( MESG )
                    CYCLE
                END IF
                ...
                IF( LB .EQ. 0 )   READ( IDEV, *, ERR=999 ) ( VGLVS( I ), I=1, NLAYREAD )
...
999 DSCM3LAY = .FALSE.
    MESG = 'ERROR: Could not read vertical layer structure ' // 'from grid description file.'
    CALL M3MSG2( MESG )
...
CONTAINS
    ...
    SUBROUTINE GRDINFO_DEFINED( KEYWORD, CVAL, RVAL,&
        ...
        IF( ( INTYPE .EQ. M3CHAR .AND. CVAL .EQ. ' '    ) .OR.      &
            ...
            EFLAG = .TRUE.
            MESG = 'ERROR: Keyword "' // TRIM( KEYWORD ) //     &
