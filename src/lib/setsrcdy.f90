...
&                     DAYBEGT, DAYENDT )
    ...
    LOGICAL       DAYLIT            ! true: date is daylight savings

    INTEGER, SAVE :: STIME_SET          ! start time HHMMSS when all srcs get same
    LOGICAL, SAVE :: FIRSTIME = .TRUE.  ! true: first time routine called
    LOGICAL, SAVE :: UFLAG              ! true: all srcs use same day start

    CHARACTER(300) MESG                 ! message buffer

    CHARACTER(16), PARAMETER :: PNAME = 'SETSRCDY'     ! program name
