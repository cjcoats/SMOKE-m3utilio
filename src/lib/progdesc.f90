...
SUBROUTINE PROGDESC( LDEV, INPROGNM )
    ...
    !
    !  DESCRIPTION:
    !       This program is used to write out a description of a program
    !
    !  REVISION  HISTORY:
    !       Version ??/???? by ???
    ...
    INTEGER     , INTENT(IN   ) :: LDEV          ! Log file unit number
    CHARACTER(*), INTENT(IN   ) :: INPROGNM      ! Name of program to write description for

    !......  Local variables
    CHARACTER(16)   NAME          ! Uppercase name of program to write descript

    !***********************************************************************
    !   begin body of subroutine PROGDESC

    NAME = INPROGNM
    CALL UPCASE( NAME )

    !......  SMOKE programs - listed in alphabetical order
    ...
    SELECT CASE( NAME )
      ...
      CASE( 'MVSETUP' )
        ...
        'code, roadtype, vehicle type, and including the speed from',   &
      ...
      CASE( 'SMK2EMIS' )
        WRITE( LDEV,92000 )                                             &
        ' ',                                                            &
        'Program SMK2EMIS converts I/O API gridded, hourly emissions ', &
      ...
      CASE( 'TMPBIO' )
        ...
        'produces time stepped gridded speciated biogenic emissions.',  &
        ' It optionally takes is a gridded winter-summer designation',  &
        'to apply winter and summer emission factors by grid cell.',    &
        ' '
      ...
      CASE DEFAULT
        WRITE( LDEV,92000 )                                             &
        ' ',                                                            &
        'No program description is available for ' // TRIM( NAME ),     &
        ' '
