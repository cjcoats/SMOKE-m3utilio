...
SUBROUTINE RDSETMASK( FNAME, JDATE, JTIME, NDIM, NDIM2, NVLIST,     &
    ...
    CHARACTER(16), PARAMETER :: PROGNAME = 'RDSETMASK'     ! program name
    ...
    DO V = 1, NVLIST
        ...
        IF( J .GT. NDIM2 ) THEN
            ...
            MESG = 'INTERNAL ERROR: Prevented overflow for read of variable "' // TRIM( VBUF ) // '"'
            CALL M3MSG2( MESG )
        ...
        VBUF = VNAMES( V )
        IF ( .NOT. READSET( FNAME, VBUF, 1, ALLFILES, JDATE, JTIME, OUTVAR( 1,J ) ) ) THEN
