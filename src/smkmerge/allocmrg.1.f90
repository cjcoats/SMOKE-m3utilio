...
!.............  The reactivity controls sum is used when there is speciation,
!               even if no reactivity controls are applied to prevent IF
!               statements in the merge loops in MRGMULT.
