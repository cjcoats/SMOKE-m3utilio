...
MODULE MODSPRO
    ...
    CHARACTER(SPNLEN3), ALLOCATABLE, PUBLIC :: INPRF( : )
        ...
        ! names of species
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SPECID( : )

    !.......  Table of species names per inventory pollutant

    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SPCNAMES( :,: )

    !.......  Table of mole-based units per inventory pollutant for all species

    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: MOLUNITS( :,: )
    ...
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SPCDEFPOL( : )     ! pols with def'ns (nspdef)
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SPCDEFLST( :,: )     ! the def'ns (mxsplst,nspdef)
    ...
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SPCLIST( : )         ! 1-d array of all species
