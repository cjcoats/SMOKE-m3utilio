...
!.........  Module-specific parameters
        INTEGER, PARAMETER, PUBLIC :: LV1 = NAMLEN3 + 2     ! "S-" len = 2
        INTEGER, PARAMETER, PUBLIC :: LV2 = NAMLEN3 * 2 + 4 ! ETJOIN len = 2
        INTEGER, PARAMETER, PUBLIC :: LV3 = NAMLEN3 * 3 + 6
...
!.........  Grouped output information and data values
        ...
        CHARACTER(CHRLEN3), ALLOCATABLE, PUBLIC :: BINUNITID ( : ) ! Unit ID
...
!.........  Dimensioned ( NSVARS, NREPORT )
        ...
        CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC :: SLUNIT( : ) ! spc var units
        CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC :: SSUNIT( : ) ! spc var units
