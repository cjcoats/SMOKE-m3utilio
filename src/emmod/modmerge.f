...
!.........  Pollutant names from inventory/temporal file
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: AEINAM( : ) ! area
        CHARACTER(NAMLEN3)             , PUBLIC :: BEINAM( 2 ) ! biogenic
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: MEINAM( : ) ! mobile
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: PEINAM( : ) ! point
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: EINAM ( : ) ! all

!.........  Associated pollutant variable names from inventory file, O=other
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: AONAMES( : ) ! area
        CHARACTER(NAMLEN3),              PUBLIC :: BONAMES( 2 ) ! biogenic
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: MONAMES( : ) ! mobile
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: PONAMES( : ) ! point
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: TONAMES( : ) ! all

!.........  Associated pollutant variable units from inventory file
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: AOUNITS( : ) ! area
        CHARACTER(NAMLEN3),              PUBLIC :: BOUNITS( 2 ) ! biogenic
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: MOUNITS( : ) ! mobile
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: POUNITS( : ) ! point
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: TOUNITS( : ) ! all

!.........  Pollutant and activity names from inventory/temporal file
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: MEANAM( : ) ! mobile
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: EANAM ( : ) ! all
...
!.........  Pollutant names from multiplicative control matrix
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: AUVNAMS( : ) ! area
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: MUVNAMS( : ) ! mobile
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: PUVNAMS( : ) ! point

!.........  Species names
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: AEMNAM  ( : ) ! area
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: BEMNAM  ( : ) ! mobile
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: MEMNAM  ( : ) ! biogenic
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: PEMNAM  ( : ) ! point
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC ::  EMNAM  ( : ) ! all
...
!.........  Map file pollutants list and physical file names
        ...
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: AMAPNAM( : )
        CHARACTER(PHYLEN3), ALLOCATABLE, PUBLIC :: AMAPFIL( : )
        INTEGER,                         PUBLIC :: MNMAP = 0
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: MMAPNAM( : )
        CHARACTER(PHYLEN3), ALLOCATABLE, PUBLIC :: MMAPFIL( : )
        INTEGER,                         PUBLIC :: PNMAP = 0
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: PMAPNAM( : )
...
!.........  Grouped variable arrays
        ...
        CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC :: GVNAMES( :,: ) ! var name
...
!.........  Units conversions information
        ...
        CHARACTER(NAMLEN3), PUBLIC :: BIOUNIT = ' '  ! biogenic input units
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: GRDUNIT( : ) ! gridded output units
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SPCUNIT( : ) ! speciation units
        CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: TOTUNIT( : ) ! st/co total units
