...
!.........  Hourly-emissions file information
    ...
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: TPNAME( : )  ! data names
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: TPUNIT( : )  ! data units
    CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC :: TPDESC( : )  ! data descs
...
!.............  Sorted profile data structures filtered from the input files
