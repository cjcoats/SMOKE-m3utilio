...
!.........  Meteorology information
    CHARACTER(NAMLEN3), PUBLIC :: TVARNAME  ! name of temperature variable to read
    CHARACTER(NAMLEN3), PUBLIC :: DATANAME  ! name of activity data name from Temporal
...
!.........  NONHAPTOG calculation information
    INTEGER, PUBLIC :: NHAP                                ! number of HAPs to subtract
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: HAPNAM( : ) ! list of HAPs
...
!.........  Emission factors data
    ...
    CHARACTER(NAMLEN3),ALLOCATABLE, PUBLIC :: MVSPOLNAMS( : )  ! arry for poll/spc names
...
!.........  Hourly speed data and control factor data
...
!.........  Index from per-source inventory array to INVSCC array (based on MICNY in MODSTCY)
    INTEGER, ALLOCATABLE, PUBLIC :: MISCC( : )     ! dim NMSRC

!.........  Speciation matrixes (mole- and mass-based)
    ...
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SPCUNIT_L( : ) ! speciation units
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SPCUNIT_S( : )

!.........  Non-speciated emissions reporting
