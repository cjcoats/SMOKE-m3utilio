...
MODULE MODDAYHR
    ...
    INCLUDE 'EMPRVT3.h90'       !  emissions private parameters
    ...
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: DYPNAM( : )
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: HRPNAM( : )

    !.......  Day- and hour-specific pol/act descriptions
    CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC :: DYPDSC( : )
    CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC :: HRPDSC( : )
    ...
    !.......   List of ORIS IDs in hour-specific data not in inventory
    INTEGER, PUBLIC :: NUNFDORS
    CHARACTER(ORSLEN3), ALLOCATABLE, PUBLIC :: UNFDORS( : )

    !.......   Data from master list of ORIS/boiler combinations
