...
!.........  Unique lists of source characteristics and associated arrays...
    CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC :: EFSDSC( : )
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: EFSNAM( : )
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: EFSUNT( : )

!.........  Variables for EF subtraction
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC :: SUBPOLS( : )   ! final subtraction list
    CHARACTER(NAMLEN3), PUBLIC :: INPUTHC   ! input hydrocarbon name
    CHARACTER(NAMLEN3), PUBLIC :: OUTPUTHC  ! output hydrocarbon name
...
!.........  Second dimension is number of activities in the inventory
    ...
    CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC:: EMTPOL( : )!pols of EMTNAM
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC:: EMTNAM( :,: )! em type
    CHARACTER(NAMLEN3), ALLOCATABLE, PUBLIC:: EMTUNT( :,: )! et units
    CHARACTER(MXDLEN3), ALLOCATABLE, PUBLIC:: EMTDSC( :,: )! et descript
